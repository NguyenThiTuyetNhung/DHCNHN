                        ...
                        <div class="row align-items-end">
                            ...
                            <div class="col-lg-9 col-md-9">
                                <div class="nav product_tab_menu justify-content-end" role="tablist">
                                    ...
                                    <a href="index.html#hot_bike" data-toggle="tab" role="tab" aria-selected="false" aria-controls="hot_bike">Nhông Xích</a>
                                    <a href="index.html#hot_tiar" data-toggle="tab" role="tab" aria-selected="false" aria-controls="hot_tiar">Giảm Xóc</a>
                                    <a href="index.html#hot_parts" data-toggle="tab" role="tab" aria-selected="false" aria-controls="hot_parts">Xăm Lốp</a>
                                    <a href="index.html#hot_wheel" data-toggle="tab" role="tab" aria-selected="false" aria-controls="hot_wheel">Nhựa</a>
                                    <a href="index.html#hot_light" data-toggle="tab" role="tab" aria-selected="false" aria-controls="hot_light">Khác</a>
                                </div>
                            </div>
                        </div>
                        <div class="row mt-60">
                                                ...
                                                <div class="single__product">
                                                    ...
                                                    <div class="product_hover">
                                                        ...
                                                        <div class="product__desc">
                                                            <h3><a href="{{ route('product.detail') }}">
                                                                {{ $product->name }}    
                                                            </a></h3>

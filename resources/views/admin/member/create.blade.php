  ...
  <section class="content-header">
    <form action="{{ route('admin.members.store') }}" method="POST" enctype="multipart/form-data">
        ...
        <div class="row">
          <div class="col-md-6">
            ...
            <div class="form-group">
              ...
              <input type="text" class="form-control" name="name" id="name" placeholder="Tên nhân viên" value="{{ old('name') }}">
           ...
           <div class="col-md-6">
             ...
             <div class="form-group">
              ...
              <select class="form-control" name="rule" id="rule">
                ...
                <option value="1" {{ old('rule') == '1' ? 'selected' : '' }}>Nhân viên</option>
                <option value="0" {{ old('rule') == '0' ? 'selected' : '' }}>Quản trị viên</option>
              </select>
      ...
      <div class="row">
        ...
        <!-- /.col -->
        <div class="col-md-1">
          <a href=" {{ route('admin.members.index') }} "><button type="button" class="btn btn-block btn-danger">Hủy bỏ</button>
           </a> 
        </div>
        <!-- /.col -->
      </div>
